...
# Base directory for images (Mac path)
BASE_DIR = "/Users/YourUsername/Pyautogui/"

# Retina scaling factor for Mac
RETINA_SCALING_FACTOR = 2  # Adjust this if you're not using a Retina display
...
class AutoClickerGUI:
    def __init__(self, root):
        ...
        # Title
        self.title_label = ttk.Label(root, text="Auto Clicker v1.0 🤝", font=("Arial", 16, "bold"))
        ...
        try:
            ...
            for condition in IMAGE_CONDITIONS:
                ...
                if location:
                    ...
                    self.root.after(1000, self.run_script)  # 1 second after clicking
                    return
